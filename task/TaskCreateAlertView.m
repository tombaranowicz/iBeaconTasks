...
const static CGFloat kTaskCreateAlertViewDefaultButtonHeight       = 50;
const static CGFloat kTaskCreateAlertViewDefaultButtonSpacerHeight = 1;
const static CGFloat kTaskCreateAlertViewCornerRadius              = 7;
const static CGFloat kCustomIOS7MotionEffectExtent                 = 10.0;

@implementation TaskCreateAlertView
...
- (void)customIOS7dialogButtonTouchUpInside: (TaskCreateAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
...
- (UIView *)createContainerView
{
    ...
    CGFloat cornerRadius = kTaskCreateAlertViewCornerRadius;
...
//    lineView.backgroundColor = [UIColor colorWithRed:198.0/255.0 green:198.0/255.0 blue:198.0/255.0 alpha:1.0f];
    lineView.backgroundColor = [Utils themeColor];
...
//        [closeButton setTitleColor:[UIColor colorWithRed:0.2f green:0.2f blue:0.2f alpha:0.5f] forState:UIControlStateHighlighted];
        [closeButton setTitleColor:[Utils themeColor] forState:UIControlStateNormal];
        [closeButton.titleLabel setFont:[UIFont boldSystemFontOfSize:14.0f]];
        [closeButton.layer setCornerRadius:kTaskCreateAlertViewCornerRadius];
...
- (CGSize)countScreenSize
{
    if ([buttonTitles count] > 0) {
        buttonHeight       = kTaskCreateAlertViewDefaultButtonHeight;
        buttonSpacerHeight = kTaskCreateAlertViewDefaultButtonSpacerHeight;
    } else {
        buttonHeight = 0;
